...
def runRoboUber(worldX,worldY,runTime,stop,junctions=None,streets=None,interpolate=False,outputValues=None,**args):
   ...
   print("Taxi's Returns:","Taxi no1:", taxi0.TaxiAcc(),"Taxi no2:", taxi1.TaxiAcc(),"Taxi no3:", taxi2.TaxiAcc(),"Taxi no4:", taxi3.TaxiAcc())
   print("\n")
   AverageTaxiReturn = (taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc()) / 4
   print("Average Taxi Return:", AverageTaxiReturn)
   print("\n")
   print("Dispatcher Revenue:", dispatcher0.DispatcherRevenue())
   print("\n")
   JointReturn = (dispatcher0.DispatcherRevenue() + taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc())
   print("Joint Return:", JointReturn)
   print("\n")
   AverageJointReturn = (dispatcher0.DispatcherRevenue() + taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc()) / 5
   print("Average Joint Return:", AverageJointReturn)
   print("\n")
   print("Exact time taxis went off duty:")
   print("Taxi no1:",taxi0.TaxiOffD())
   print("Taxi no2:",taxi1.TaxiOffD())
   print("Taxi no3:",taxi2.TaxiOffD())
   print("Taxi no4:",taxi3.TaxiOffD())
   ...
   #print("Taxi Returns:")
   #print("Taxi1:", taxi0.TaxiAcc(), "Taxi2:", taxi1.TaxiAcc(), "Taxi3:", taxi2.TaxiAcc(), "Taxi4",
         #taxi3.TaxiAcc(), "\n")

   #avgTaxiReturn = (taxi0.TaxiAccount() + taxi1.TaxiAccount() + taxi2.TaxiAccount() + taxi3.TaxiAccount()) / 4
   #print("Average Taxi Return:", avgTaxiReturn, "\n")

   #print("Dispatcher Account:", dispatcher0.DispatcherRevenue(), "\n")

   #avgJointReturn = (taxi0.TaxiAccount() + taxi1.TaxiAccount() + taxi2.TaxiAccount() + taxi3.TaxiAccount() + dispatcher0.DispatcherRevenue()) / 5
   #print("Average Joint Return:", avgJointReturn, "\n")

  # print("Times Taxi Went Off Duty:")
   #print("Taxi1:", taxi0.TaxiOffDuty(), "Taxi2:", taxi1.TaxiOffDuty(), "Taxi3:", taxi2.TaxiOffDuty(), "Taxi4",
         #taxi3.TaxiOffDuty())
