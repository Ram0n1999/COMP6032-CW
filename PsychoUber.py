   ...
   while threadTime < threadRunTime:
         ...
         if stop.is_set():
            ...
            if threadTime != svcArea.simTime:
               threadTime += 1
            time.sleep(0.0001)
   print("Taxi's Returns:", "Taxi no1:", taxi0.TaxiAcc(), "Taxi no2:", taxi1.TaxiAcc(), "Taxi no3:",
         taxi2.TaxiAcc(), "Taxi no4:", taxi3.TaxiAcc())
   print("\n")
   AverageTaxiReturn = (taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc()) / 4
   print("Average Taxi Return:", AverageTaxiReturn)
   print("\n")
   print("Dispatcher Revenue:", dispatcher0.DispatcherRev())
   print("\n")
   JointReturn = (
           dispatcher0.DispatcherRev() + taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc())
   print("Joint Return:", JointReturn)
   print("\n")
   AverageJointReturn = (
                                dispatcher0.DispatcherRev() + taxi0.TaxiAcc() + taxi1.TaxiAcc() + taxi2.TaxiAcc() + taxi3.TaxiAcc()) / 5
   print("Average Joint Return:", AverageJointReturn)
   print("\n")
   print("Time taxis went off duty:")
   print("Taxi no1:", taxi0.TaxiOffDuty())
   print("Taxi no2:", taxi1.TaxiOffDuty())
   print("Taxi no3:", taxi2.TaxiOffDuty())
   print("Taxi no4:", taxi3.TaxiOffDuty())
